...
tv_show_creator            = FactoryBot.create(:role, work_type: "TV Show", name: "Creator")
tv_show_producer           = FactoryBot.create(:role, work_type: "TV Show", name: "Producer")
tv_show_executive_producer = FactoryBot.create(:role, work_type: "TV Show", name: "Executive Producer")
tv_show_co_producer        = FactoryBot.create(:role, work_type: "TV Show", name: "Co-Producer")
tv_show_showrunner         = FactoryBot.create(:role, work_type: "TV Show", name: "Showrunner")

tv_season_showrunner       = FactoryBot.create(:role, work_type: "TV Season", name: "Showrunner")

tv_episode_writer          = FactoryBot.create(:role, work_type: "TV Episode", name: "Writer")
tv_episode_director        = FactoryBot.create(:role, work_type: "TV Episode", name: "Director")
tv_episode_editor          = FactoryBot.create(:role, work_type: "TV Episode", name: "Film Editor")
tv_episode_composer        = FactoryBot.create(:role, work_type: "TV Episode", name: "Composer")
...
comic_book_cartoonist      = FactoryBot.create(:role, work_type: "Comic Book", name: "Cartoonist")
comic_book_writer          = FactoryBot.create(:role, work_type: "Comic Book", name: "Writer")
comic_book_penciller       = FactoryBot.create(:role, work_type: "Comic Book", name: "Penciller")
comic_book_inker           = FactoryBot.create(:role, work_type: "Comic Book", name: "Inker")
comic_book_colorist        = FactoryBot.create(:role, work_type: "Comic Book", name: "Colorist")
comic_book_letterer        = FactoryBot.create(:role, work_type: "Comic Book", name: "Letterer")
comic_book_cover_artist    = FactoryBot.create(:role, work_type: "Comic Book", name: "Cover Artist")

graphic_novel_cartoonist   = FactoryBot.create(:role, work_type: "Graphic Novel", name: "Cartoonist")
graphic_novel_writer       = FactoryBot.create(:role, work_type: "Graphic Novel", name: "Writer")
graphic_novel_penciller    = FactoryBot.create(:role, work_type: "Graphic Novel", name: "Penciller")
graphic_novel_inker        = FactoryBot.create(:role, work_type: "Graphic Novel", name: "Inker")
graphic_novel_colorist     = FactoryBot.create(:role, work_type: "Graphic Novel", name: "Colorist")
graphic_novel_letterer     = FactoryBot.create(:role, work_type: "Graphic Novel", name: "Letterer")
graphic_novel_cover_artist = FactoryBot.create(:role, work_type: "Graphic Novel", name: "Cover Artist")

video_game_designer        = FactoryBot.create(:role, work_type: "Video Game", name: "Designer")
video_game_developer       = FactoryBot.create(:role, work_type: "Video Game", name: "Developer")
...
radio_show_host            = FactoryBot.create(:role, work_type: "Radio Show", name: "Host")
radio_show_producer        = FactoryBot.create(:role, work_type: "Radio Show", name: "Producer")
