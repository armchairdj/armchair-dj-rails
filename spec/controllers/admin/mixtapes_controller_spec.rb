...
RSpec.describe Admin::MixtapesController, type: :controller do
  ...
  context "as root" do
    ...
    describe "GET #show" do
      ...
      it { is_expected.to successfully_render("admin/mixtapes/show") }
    ...
    describe "GET #new" do
      ...
      it { is_expected.to successfully_render("admin/mixtapes/new") }
    ...
    describe "GET #edit" do
      ...
      it { is_expected.to successfully_render("admin/mixtapes/edit") }
      it { is_expected.to assign(mixtape, :mixtape) }
      it { is_expected.to prepare_the_mixtape_form }
    end
    ...
    describe "PUT #update" do
      ...
      context "publishing" do
        ...
        context "with failed transition" do
          ...
          it { is_expected.to successfully_render("admin/mixtapes/edit").with_flash(
      ...
      context "unpublishing" do
        ...
        context "with invalid params" do
          ...
          it { is_expected.to successfully_render("admin/mixtapes/edit").with_flash(:error, nil) }
