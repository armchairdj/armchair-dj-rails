...
RSpec::Matchers.define :define_the_review_tabs do
  match do
    ...
    expect(assigns(:available_tabs)).to include("article-new-work")
    expect(assigns(:available_tabs)).to include("article-choose-work")
  end

  match_when_negated do
    is_expected.to_not prepare_the_review_tabs

    expect(assigns(:available_tabs)).to_not include("article-new-work")
    expect(assigns(:available_tabs)).to_not include("article-choose-work")
  end
...
RSpec::Matchers.define :define_the_standalone_tab do
  match do
    expect(assigns(:available_tabs)).to include("article-standalone")
  end

  match_when_negated do
    expect(assigns(:available_tabs)).to_not include("article-standalone")
  end
...
RSpec::Matchers.define :define_only_the_standalone_tab do
  match do
    ...
    expect(assigns(:selected_tab)).to eq("article-standalone")
  end
