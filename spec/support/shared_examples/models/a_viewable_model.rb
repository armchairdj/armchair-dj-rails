RSpec.shared_examples "a viewable model" do
  ...
  #     specify { expect(    draft_instance.non_viewable_works.length).to eq(0) }
  #     specify { expect(scheduled_instance.non_viewable_works.length).to eq(0) }
  #     specify { expect(published_instance.non_viewable_works.length).to eq(1) }
  #   end
  #
  ...
  #         expect(subject.viewable_post_count    ).to eq(2)
  #       end
  #     end
  #   end
  #
