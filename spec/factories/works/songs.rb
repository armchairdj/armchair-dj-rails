FactoryBot.define do
  factory :song do
    ...
    factory  :minimal_song, class: "Song", parent: :minimal_work do; end
    factory :complete_song, class: "Song", parent: :minimal_work do; end
    factory  :stuffed_song, class: "Song", parent: :minimal_work do; end
