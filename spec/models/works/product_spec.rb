...
RSpec.describe Product, type: :model do
  ...
  context "STI" do
    context "class" do
      ...
      specify { expect(described_class.true_human_model_name).to eq("Product") }
    end
    ...
    context "instance" do
      ...
      specify { expect(instance.type                 ).to eq("Product") }
      specify { expect(instance.true_model_name.name ).to eq("Product") }
      specify { expect(instance.true_human_model_name).to eq("Product") }
    end
  end
